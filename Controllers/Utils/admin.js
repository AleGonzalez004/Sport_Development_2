...
function Categorias() {
    window.location.href = "/Vistas/Administradores/categoria.html";
}
function Deportes() {
    window.location.href = "/Vistas/Administradores/deporte.html";
}
function Generos() {
    window.location.href = "/Vistas/Administradores/genero.html";
}
function Imagenes() {
    window.location.href = "/Vistas/Administradores/imagen.html";
}
function Marcas() {
    window.location.href = "/Vistas/Administradores/marca.html";
}
function Tallas() {
    window.location.href = "/Vistas/Administradores/talla.html";
}
function Clientes() {
    window.location.href = "/Vistas/Administradore/cliente.html";
}
function Administradores() {
    window.location.href = "/Vistas/Administradores/cliente.html";
}
function Productos() {
    window.location.href = "/Vistas/Administradores/producto.html";
}
function Graficos() {
    window.location.href = "/Vistas/Administradores/grafico.html";
}
function Comentarios() {
    window.location.href = "/Vistas/Administradores/comentario.html";
}
function Perfil() {
    window.location.href = "/Vistas/Administradores/Perfil.html";
}