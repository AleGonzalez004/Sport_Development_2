                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-end " id="menu">
                        <li class="nav-item p-2">
                            <a class="nav-link p-2" href="/Vistas/Publico/index.html">
                                Inicio  .<span class="icon bi-box2-fill mr-2"></span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link p-2 justify-content-end" href="/Vistas/Publico/login.html">
                                Iniciar Sesión  .<span class="icon bi-door-open-fill mr-2 justify-content-end"></span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link p-2 justify-content-end" href="/Vistas/Publico/catalogo.html">
                                Catalogo  .<span class="icon bi-wallet-fill mr-2"></span>
                            </a>
                        </li>
                    </ul>
                </form>
